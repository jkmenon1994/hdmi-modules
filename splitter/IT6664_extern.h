...
extern void it6664_RXHDCP_Set(iTE_u8 sts);
extern void it6664_EdidMode_Start(void);
extern void IT6664_SetRxLED(iTE_u8  LED_SEL, iTE_u8 on);
extern iTE_u8 CheckSinkSCDC(iTE_u8 port);
...
#endif
//MHL
#define mhlrxrd(offset)						iTE_I2C_ReadByte(RXMHLAddr, offset)
#define mhlrxwr(offset,data)				iTE_I2C_WriteByte(RXMHLAddr, offset, data)
#define mhlrxbrd(offset,byteno,rddata)		iTE_I2C_ReadBurst(RXMHLAddr, offset, byteno, rddata)
#define mhlrxbwr(offset,byteno,rddata)		iTE_I2C_WriteBurst(RXMHLAddr, offset, byteno, rddata)
#define mhlrxset(offset,mask,data)			iTE_I2C_SetByte(RXMHLAddr, offset, mask, data)
//TX
#define h2txrd(port,offset)					iTE_I2C_ReadByteP(TXP0Addr,port,offset)
#define h2txwr(port,offset,data)			iTE_I2C_WriteByteP(TXP0Addr,port,offset,data)
#define h2txset(port,offset,mask,data)		iTE_I2C_SetByteP(TXP0Addr, port,offset, mask, data)
#define h2txbrd(port,offset,byteno,rddata)	iTE_I2C_ReadBurstP(TXP0Addr,port, offset, byteno, rddata)
#define h2txcomwr(offset,data)				iTE_I2C_WriteByte(TXComAddr, offset, data)
#define h2txcomrd(offset)					iTE_I2C_ReadByte(TXComAddr, offset)
#define h2txcomset(offset,mask,data)		iTE_I2C_SetByte(TXComAddr, offset, mask, data)
#define h2txcombwr(offset,byteno,rddata)	iTE_I2C_WriteBurst(TXComAddr, offset, byteno, rddata)
//SP
#define h2spset(offset,mask,data)			iTE_I2C_SetByte(SWAddr, offset, mask, data)
#define h2spwr(offset,data)					iTE_I2C_WriteByte(SWAddr, offset, data)
#define h2spbrd(offset,byteno,rddata)		iTE_I2C_ReadBurst(SWAddr, offset, byteno, rddata)
#define h2sprd(offset) 						iTE_I2C_ReadByte(SWAddr, offset)
#define	h2spbwr(offset,byteno,rddata)		iTE_I2C_WriteBurst(SWAddr, offset, byteno, rddata)
//RX
#define h2rxwr(offset,data)					iTE_I2C_WriteByte(RXP0Addr, offset, data)
#define h2rxrd(offset) 						iTE_I2C_ReadByte(RXP0Addr, offset)
#define h2rxset(offset,mask,data) 			iTE_I2C_SetByte(RXP0Addr, offset, mask, data)
#define h2rxbrd(offset,byteno,rddata)		iTE_I2C_ReadBurst(RXP0Addr,offset, byteno, rddata)
//EDID
#define h2rx_edidwr(offset,data)			iTE_I2C_WriteByte(RXEDID_Addr,offset,data)
